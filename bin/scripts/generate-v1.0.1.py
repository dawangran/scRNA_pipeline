...
#    plot_base64.append(open(path+'/07.report/div/anno_chsize.div',"r").read())
    ...
    '''
    plot_order = ['plot1','plot2','plot3','plot4','plot5','plot6']
    ...
    if os.path.exists(path+'/07.report/div/anno_chsize.div'):
        report=html.safe_substitute(sample_info=ID, samplename=stat['samplename'],\
                    ...
                    cluster_cell=stat['cluster_cell'],\
                       ...
                       plot4=plot_dict['plot4'],plot5=plot_dict['plot5'],plot6=plot_dict['plot6'],table = table,r_m_geno=stat['r_m_geno'],
                r_m_ex=stat['r_m_ex'],
        ...
        report=html.safe_substitute(sample_info=ID, samplename=stat['samplename'],\
                    ...
                    cluster_cell=stat['cluster_cell'],\
                       ...
                       plot6="There is no such species reference for annnotation.",
                r_m_ex=stat['r_m_ex'],
                r_m_intro=stat['r_m_intro'],
                r_m_ex_intro=stat['r_m_ex_intro'],
                r_m_anti=stat['r_m_anti'],
