...
library(patchwork)
library(dplyr)
source("/jdfssz1/ST_SUPERCELLS/P18Z10200N0350/Automated/USER/mawen/src/Droplet_scRNA_V2.4/scripts/getColorPalette.R")
...
#      rownames(out) <- rownames(object.combined.hesc)
  ...
  celltype_cell_merge <- unite(celltype_cell_merge, "CellType", CellType, CellTypeNum, sep = " CellTypeNum: ")
